            ...
            <div className="relative z-0">
                <div className="relative z-1 flex flex-col mx-auto pt-5 pb-10 text-koguma-text-light max-w-5xl font-inter text-center justify-center">
                    <div className="flex flex-col mb-20 gap-6 md:text-2xl justify-center text-left mx-auto opacity-90">
                        ...
                        <p>
                            For 11 years in music production, I&apos;ve wanted
                            to start a personal page to document my venture
                            through music, although I&apos;m not always blessed
                            ...
                            genre. Sometimes I&apos;d like to deviate from my
                            writing and be interested in J-Rock and orchestral
                            pieces.
                        </p>
                        <p>
                            With that being my introduction, I will be looking
                            forward to write more music with you!~
                        </p>
                    </div>
