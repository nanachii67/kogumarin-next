        ...
        <div className="relative z-1 flex flex-col mx-auto pt-5 pb-10 text-koguma-text-light max-w-5xl font-inter text-center justify-center">
          <div className="flex flex-col mb-20 gap-6 md:text-2xl justify-center text-left mx-auto">
            ...
            <p>
              ...
              synthpop, much like{" "}
              <span className="underline underline-offset-3 decoration-koguma-text-light/50 font-medium">
                <a href="https://open.spotify.com/artist/29O9ZebFa65aIEvMaW5pQY">
                  Snail's House
                </a>
                ,{" "}
                <a href="https://open.spotify.com/artist/4YqfXU53VVYBunSuvrDZYO">
                  Synthion
                </a>
                ,{" "}
                <a href="https://open.spotify.com/artist/2RssKQtZRWjMjZT0Eu9a2Q">
                  Stessie
                </a>
                ,{" "}
